...
public class GithubAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    public GithubAuthenticationFilter(RequestMatcher requiresAuthenticationRequestMatcher) {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException {
        ...
        return getAuthenticationManager().authenticate(new GithubAuthenticationToken(principal, credentials));
    }
}
